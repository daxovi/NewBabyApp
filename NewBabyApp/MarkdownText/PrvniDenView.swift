        ...
        ScrollView {
            ...
            **První močení a smolka:**
            ...
            """
                ...
                .onAppear{
                    if let filePath = Bundle.main.path(forResource: "prvniDen", ofType: "md") {
                        do {
                            let content = try String(contentsOfFile: filePath)
                            markdownText = "content *QW*"
                        } catch {
                            print("Chyba při čtení souboru: \(error)")
                        }
                    }
                }
                .padding()
